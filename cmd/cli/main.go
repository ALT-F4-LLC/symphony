...
var (
	...
	managerPvGetDevice           = managerPvGet.Arg("device", "Specific physical volume to retrieve.").Required().String()
	...
	managerVgCreateDevice        = managerVgCreate.Arg("device", "Set volume group device.").Required().String()
	managerVgCreateID            = managerVgCreate.Arg("id", "Set volume group id.").Required().String()
