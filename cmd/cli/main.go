...
var (
	...
	removeCommandMemberID = removeCommand.Arg("member-id", "Raft member ID to be removed from the cluster.").Required().Uint64()
...
func main() {
	...
	case removeCommand.FullCommand():
		cli.RemoveHandler(removeCommandMemberID, socket)
